...
mod batched_image {
    ...
    use iced::widget::shader::{self as shader_widget, Pipeline, Program};
    ...
    /// No-op pipeline for batched primitives.
    ...
    impl shader_widget::Primitive for ImagePrimitive {
        ...
        fn prepare(
            ...
            // No-op: batching handles everything via BatchPrimitive
        }
    }
